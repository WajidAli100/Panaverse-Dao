...
import OutcomImage from "@/assets/images/left.png"
import Image from "next/image"

const outcomPoints = ["Product Ownership", "Freelacing", "Global Marketing by DAO", "Boosting Economy."]
            ...
            <Wraper>
                <div className="flex gap-x-8 items-center flex-col-reverse md:flex-row">
                    ...
                    <div className="flex-1">
                        <Image src={OutcomImage} alt="outcom program" />
                    </div>
                    {/* right section */}
                    <div className="flex-1">
